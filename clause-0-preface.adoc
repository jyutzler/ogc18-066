...
This document provides the set of revision notes for the existing (( standard )) version (( version number )) ( OGC (( OGC document number )) ) and does not modify that standard.
